		...
		edit: function edit(_ref) {
			...
			return [React.createElement(
				...
				React.createElement(SelectControl, {
					...
					options: [{ label: __('Select code language'), value: '' }].concat(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_keys___default()(__WEBPACK_IMPORTED_MODULE_4__assets_prism_languages_json__["languages"]).map(function (lang) {
						return { label: __WEBPACK_IMPORTED_MODULE_4__assets_prism_languages_json__["languages"][lang].title, value: lang };
					})),
				...
				React.createElement(
					...
					__WEBPACK_IMPORTED_MODULE_4__assets_prism_languages_json__["languages"][attributes.language].title
				)
			)];
		},
